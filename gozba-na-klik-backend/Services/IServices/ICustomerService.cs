...
namespace gozba_na_klik_backend.Services.IServices
{
    public interface ICustomerService
    {
        ...
        Task<CreditCardResponseDto> CreateCreditCardAsync(string customerId, CreateCreditCardDto newCreditCard, string? ownerId);
        Task<CreditCardResponseDto> UpdateCreditCardAsync(string customerId, int creditCardId, CreateCreditCardDto updatedCreditCard, string? ownerId);
        Task DeleteCreditCardAsync(string customerId, int creditCardId, string? ownerId);
        Task<Address> CreateAddressAsync(string customerId, CreateAddressDto updatedAddress, string? ownerId);
        ...
        Task<Address> UpdateAddressAsync(string customerId, int addressId, CreateAddressDto updatedAddress, string? ownerId);
