...
namespace gozba_na_klik_backend_Tests
{
    public class CourierServiceTest
    {
        ...
        public async Task GetByIdAsync_ExistingId_ReturnsCourier()
        {
            ...
            var service = new CourierService(stubRepository, authService.Object);

            // Act
            var courier = await service.GetByIdAsync("c1a2b3d4-e5f6-7890-ab12-cd34ef56gh14");
        ...
        public async Task CreateAsync_ValidRegistration_ReturnsAuthTokenAndCreatesCourier()
        {
            ...
            const string expectedToken = "simulated_jwt_token_12345";
            ...
            var service = new CourierService(mockCourierRepository.Object, mockAuthService.Object);
        ...
        public async Task UpdateWorkingHoursAsync_ValidCourier_CallsRepository()
        {
            ...
            var authService = new Mock<IAuthService>();
            var service = new CourierService(mockRepo.Object, authService.Object);
